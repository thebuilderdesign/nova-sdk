...
Currency.NOVA = /*#__PURE__*/new Currency(18, 'ETH', 'Ether');
/**
...
var NOVA = Currency.NOVA;
var BINANCE_COIN = Currency.BINANCE_COIN;
var DEFAULT_CURRENCIES = [ETHER, NOVA, BINANCE_COIN];
...
export { BINANCE_COIN, Blockchain, ChainId, Currency, CurrencyAmount, DEFAULT_CURRENCIES, ETHER, FACTORY_ADDRESSES, Fetcher, Fraction, INIT_CODE_HASH, InsufficientInputAmountError, InsufficientReservesError, MINIMUM_LIQUIDITY, NOVA, Pair, Percent, Price, Rounding, Route, Router, Token, TokenAmount, Trade, TradeType, WETH, currencyEquals, inputOutputComparator, tradeComparator };
